...
public class NfcDemoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        //���������Լ��ݵ�nfcЭ�飬����Ϊnfca��nfcv
		//��Intent filters����������Ҫ�����Intent��һ��tag����⵽ʱ�ȼ��ǰ̨����ϵͳ��
		//���ǰ̨Activity����Intent filter��Ҫ����ôǰ̨��Activity�Ľ������Intent��
		//��������ϣ�ǰ̨����ϵͳ��Intentת��Intent����ϵͳ�����ָ����null��Intent filters��
		//������tag����⵽ʱ���㽫�յ�TAG_DISCOVERED intent�������ע����Ӧ��ֻ��������Ҫ��Intent��
		techList = new String[][] {
